...
const config = {
  "generator": {
    ...
    "previewFeatures": [],
    "sourceFilePath": "E:\\breadstock\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../.env",
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/node_modules/@prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Role {\n  id          Int      @id @default(autoincrement())\n  name        String   @unique\n  description String?\n  createdAt   DateTime @default(now())\n  updatedAt   DateTime @updatedAt\n  users       User[]\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  email     String   @unique\n  password  String\n  name      String?\n  roleId    Int\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n  role      Role     @relation(fields: [roleId], references: [id])\n\n  @@map(\"users\")\n}\n",
  "inlineSchemaHash": "84dd52292b2276d9f867750deb737730856d9047f1994c709a3ed5d4c52fbd24",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/node_modules/@prisma/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/node_modules/@prisma/schema.prisma")
